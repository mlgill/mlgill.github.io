...
│   ├── 📄 education.yml, experience.yml, patents.yml, presentations.yml: CV data
...
└── 📂 _sass/: contains the SASS files that define the style of the website
    ...
    ├── 📄 _cv-standalone.scss: style of the web CV
...
CV content is stored in the topic-specific YAML files under [\_data](_data/).
The descriptive and concise web and print pages all render through
[\_includes/cv-content.liquid](_includes/cv-content.liquid).
